...
%\section{Badanie sieci o~zwiększonym poziomie złożoności}
...
wykonującej podobne zadanie (przy~zbiorze CIFAR-10 może to~być np.~sieć AlexNet). Następnie w~celu poprawy jakości
